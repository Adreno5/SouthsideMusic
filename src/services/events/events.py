...
PLAY_STORABLE = 'play_storable'
POST_PLAY_STORABLE = 'post_play_storable'
PLAY_PLAYLIST_STORABLE = 'play_playlist_storable'
PLAY_SONG_AT_INDEX = 'play_song_at_index'
PLAY_START_PLAYLIST = 'play_start_playlist'
PLAY_CONTINUE_LAST_SONG = 'play_continue_last_song'
PLAYBACK_SONG_LOADING = 'playback_song_loading'
PLAYBACK_IMAGE_LOADED = 'playback_image_loaded'
