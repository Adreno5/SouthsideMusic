...
TRANSLATIONS: dict[Language, dict[str, str]] = {'en_US': {'dependences_window.audio_output_checking': 'Audio Output: Checking',
           ...
           'events_services.imported_successfully': 'Imported successfully',
           'events_services.my_folder': 'my folder',
           'events_services.rename_folder': 'Rename Folder',
           'events_services.renamed_successfully': 'Renamed successfully',
           ...
           'main_window.llm_ask_onerad': 'Ask Onerad',
           'main_window.llm_cancel': 'Cancel',
           'main_window.llm_clear_chat': 'Clear chat',
           'main_window.llm_confirm_execute': 'Confirm',
           'main_window.llm_confirm_then_execute': 'Confirm to execute these actions.',
           'main_window.llm_copy_chat': 'Copy chat',
           'main_window.llm_done': 'Done.',
           'main_window.llm_needs_confirmation': 'Needs confirmation',
           ...
           'playing_manager.failed_to_download_missing_cached_files': 'Failed to download missing cached files.',
           'playing_manager.failed_to_download_song_assets': 'Failed to download song assets.',
           'playing_manager.failed_to_start_streaming_playback': 'Failed to start streaming playback.',
           'playing_manager.first_song_in_playlist': 'This song is the first song in the playlist.',
           'playing_manager.last_song_in_playlist': 'This song is the last song in the playlist.',
           'playing_manager.playback_failed': 'Playback failed',
           'playing_manager.warning': 'Warning',
           'update.failed_try_again_later': 'Failed to update. Please try again later.',
           'update.skip': 'Skip',
           'update.update': 'Update',
           'update.update_available': 'Update Available',
           'update.update_complete': 'Update Complete',
 ...
 'zh_CN': {'dependences_window.audio_output_checking': '音频输出：检查中',
           ...
           'events_services.enter_new_name_of_your_folder': '输入文件夹的新名称',
           'events_services.folder_added_to_cloud': '文件夹 {folder_name} 已添加到云端',
           'events_services.folder_added_to_local': '文件夹 {folder_name} 已添加到本地',
           'events_services.folder_renamed_to': '文件夹 {folder_name} 已重命名为 {new_name}',
           'events_services.imported_successfully': '导入成功',
           'events_services.my_folder': '我的文件夹',
           'events_services.rename_folder': '重命名文件夹',
           'events_services.renamed_successfully': '重命名成功',
           ...
           'main_window.llm_ask_onerad': '问 Onerad',
           'main_window.llm_cancel': '取消',
           'main_window.llm_clear_chat': '清空聊天',
           'main_window.llm_confirm_execute': '确认执行',
           'main_window.llm_confirm_then_execute': '确认后执行这些操作。',
           'main_window.llm_copy_chat': '复制聊天',
           'main_window.llm_done': '完成。',
           'main_window.llm_needs_confirmation': '需要确认',
           'main_window.llm_no_pending_tools_parsed': '没有解析到待执行工具',
           ...
           'playing_manager.failed_to_download_missing_cached_files': '下载缺失的缓存文件失败。',
           'playing_manager.failed_to_download_song_assets': '下载歌曲资源失败。',
           'playing_manager.failed_to_start_streaming_playback': '启动流式播放失败。',
           'playing_manager.first_song_in_playlist': '这已经是播放列表中的第一首歌。',
           'playing_manager.last_song_in_playlist': '这已经是播放列表中的最后一首歌。',
           'playing_manager.playback_failed': '播放失败',
           'playing_manager.warning': '警告',
           'update.failed_try_again_later': '更新失败，请稍后重试。',
           'update.skip': '跳过',
           'update.update': '更新',
           'update.update_available': '发现更新',
           'update.update_complete': '更新完成',
           'update.update_completed_restart': '更新已完成，点击 OK 重启。',
           'update.update_failed': '更新失败',
           'update.version_available': '{tag_name} 可用，要现在更新吗？',
